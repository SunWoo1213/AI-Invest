...
## 3. 검증 기록 작성
`docs/harness/records/<영역>/<작업-slug>-verification-2026-06-02.md`에 한국어로: 날짜·검증 대상·실행한 명령과 결과(통과/실패)·실행하지 않은 명령과 이유·발견된 문제·후속 위험·관련 feature 문서 링크. 명령 출력의 시크릿은 제외한다.
