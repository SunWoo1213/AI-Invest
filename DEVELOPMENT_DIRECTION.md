...
주의: `docs/architecture/ARCHITECTURE.md`에는 Next.js, TypeScript, uv 중심의 미래 청사진이 섞여 있습니다. 실제 코드는 React Vite와 `requirements.txt` 기반 FastAPI 프로젝트입니다. 개발 판단은 현재 실행되는 코드 구조를 우선합니다.
