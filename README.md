...
- [AI Invest — 글로벌 금융 데이터 \& AI 투자 리포트 플랫폼](#ai-invest--글로벌-금융-데이터--ai-투자-리포트-플랫폼)
  - [한눈에 보기](#한눈에-보기)
    - [화면](#화면)
  - [목차](#목차)
  - [1. 주요 기능](#1-주요-기능)
...
- **수정**: 게이트를 끄거나 느슨하게 하지 않고, 편집장에게 오늘 날짜 · 기준 시각 · 알려진 데이터 한계를 주고 "한계가 명시되어 있으면 그 자체로는 FAIL이 아니다"를 명시했습니다
