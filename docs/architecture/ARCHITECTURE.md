...
|   `-- vercel.json
|-- docs/
|   |-- architecture/          # Architecture, code map, structure analysis, function spec
|   |-- guides/                # Environment and external integration setup guides
|   |-- deliverables/          # Capstone final deliverables
|   `-- harness/               # Feature docs and records/<area>/ change records
|-- scripts/                   # Doc sync checker, test_api.py / test_db.py helpers
