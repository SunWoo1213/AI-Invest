...
docs/architecture/          ARCHITECTURE, CODE_UNDERSTANDING, this file, PROJECT_FUNCTION_DETAIL_SPEC
docs/guides/                Environment variable and external integration setup guides
docs/deliverables/          Capstone final deliverables
docs/harness/               Feature docs, records/<area>/ change records, harness workflow docs
scripts/                    Doc sync checker, test_api.py / test_db.py helper scripts
...
- `docs/architecture/ARCHITECTURE.md` has been refreshed to match the current React/Vite + FastAPI implementation.
- `docs/architecture/PROJECT_STRUCTURE_ANALYSIS.md` is a concise structure map, while `docs/architecture/ARCHITECTURE.md` explains runtime boundaries and data flow.
