...
`docs/harness/records/deployment/vercel-supabase-deployment-plan-2026-06-01.md`의 후속 구현으로, Vercel frontend, Supabase PostgreSQL, persistent FastAPI backend 배포에 필요한 코드/설정 기반을 추가했다.
