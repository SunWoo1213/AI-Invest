...
`docs/harness/records/deployment/vercel-supabase-integration-next-plan-2026-06-03.md`와 `docs/guides/VERCEL_SUPABASE_INTEGRATION_GUIDE.md`를 기준으로, 실제 Vercel/Supabase 계정 연결 전에 저장소에서 준비할 수 있는 backend 설정과 문서 계약을 보강한다.
...
- `docs/guides/VERCEL_SUPABASE_INTEGRATION_GUIDE.md`
