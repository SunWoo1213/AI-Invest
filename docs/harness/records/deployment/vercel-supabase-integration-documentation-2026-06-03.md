...
- `.env` 값은 읽거나 출력하지 않았다.
- 기존 `docs/harness/records/deployment/vercel-supabase-deployment-plan-2026-06-01.md`, `docs/harness/features/deployment-runtime.md`, `frontend/vercel.json`, `frontend/package.json`을 확인했다.
