...
- 프론트엔드는 Supabase client를 직접 쓰지 않는다. anon key를 브라우저 번들에 넣지 않는 것이 현재 운영 기준이다. ([VERCEL_SUPABASE_INTEGRATION_GUIDE.md](docs/guides/VERCEL_SUPABASE_INTEGRATION_GUIDE.md) 95번 줄, [supabase-console-tasks-2026-06-03.md](docs/harness/records/deployment/supabase-console-tasks-2026-06-03.md) 섹션 5)
...
- service role key/DB password는 노출 시 즉시 rotate한다([supabase-console-tasks-2026-06-03.md](docs/harness/records/deployment/supabase-console-tasks-2026-06-03.md) 섹션 8 기준).
...
- 연관 문서: [supabase-console-tasks-2026-06-03.md](docs/harness/records/deployment/supabase-console-tasks-2026-06-03.md) 섹션 5, [VERCEL_SUPABASE_INTEGRATION_GUIDE.md](docs/guides/VERCEL_SUPABASE_INTEGRATION_GUIDE.md)
