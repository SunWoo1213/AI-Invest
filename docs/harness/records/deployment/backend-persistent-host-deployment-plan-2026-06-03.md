...
- 문서: `docs/harness/features/deployment-runtime.md`, `docs/harness/records/deployment/vercel-supabase-deployment-plan-2026-06-01.md`, `docs/harness/records/deployment/vercel-supabase-integration-next-plan-2026-06-03.md`, `DEVELOPMENT_DIRECTION.md`, `docs/harness/feature-index.md`
