...
함께 참고:
- `docs/harness/records/deployment/backend-free-tier-deployment-plan-2026-06-03.md` (무료 티어 트레이드오프)
- `docs/harness/records/deployment/vercel-supabase-deployment-plan-2026-06-01.md` (환경변수 인벤토리)
...
- 문서: `docs/harness/records/deployment/backend-free-tier-deployment-plan-2026-06-03.md`, `docs/harness/records/deployment/backend-persistent-host-deployment-plan-2026-06-03.md`, `docs/harness/records/deployment/vercel-supabase-deployment-plan-2026-06-01.md`, `docs/harness/features/deployment-runtime.md`, `docs/harness/feature-index.md`
