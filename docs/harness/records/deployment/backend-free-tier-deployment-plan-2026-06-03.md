...
함께 참고할 문서:
- `docs/harness/records/deployment/backend-persistent-host-deployment-plan-2026-06-03.md` (옵션 A 전체 절차)
...
- 문서: `docs/harness/records/deployment/backend-persistent-host-deployment-plan-2026-06-03.md`, `docs/harness/records/deployment/vercel-supabase-deployment-plan-2026-06-01.md`, `docs/harness/features/deployment-runtime.md`, `docs/harness/feature-index.md`
