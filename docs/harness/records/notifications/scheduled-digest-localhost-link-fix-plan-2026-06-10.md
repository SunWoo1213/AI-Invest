...
- `docs/harness/records/notifications/notification-public-link-remediation-plan-2026-06-10.md`
- `docs/harness/records/notifications/notification-public-link-remediation-implementation-2026-06-10.md`
...
- `.env.example`, `docs/guides/ENVIRONMENT_VARIABLE_SETUP.md`에 `FRONTEND_BASE_URL`의 운영 설정 의미를 명확히 보강(이미 정기요약 구현 때 추가됐는지 확인 후 정정).
...
- 기존 `docs/harness/records/notifications/notification-public-link-remediation-plan-2026-06-10.md` / `...-implementation-2026-06-10.md` — 코드와 불일치(`FRONTEND_PUBLIC_BASE_URL` 미존재) 정정 또는 대체 명시.
