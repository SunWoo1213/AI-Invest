...
`docs/harness/records/notifications/gmail-only-email-notification-plan-2026-06-02.md`에 따라 관심자산 알림의 이메일 발송 경로를 Gmail API로 단일화하고, 이메일 인증 코드가 API 응답으로 노출되던 prototype 흐름을 제거했다.
