...
관련 계획서: `docs/harness/records/notifications/scheduled-digest-localhost-link-fix-plan-2026-06-10.md`
...
- 기존 불일치 문서 `docs/harness/records/notifications/notification-public-link-remediation-plan-2026-06-10.md` / `...-implementation-2026-06-10.md`는 코드에 없는 `FRONTEND_PUBLIC_BASE_URL`을 전제하므로 이 구현 기록이 실제 동작의 기준이다.
