...
- `GMAIL_CLIENT_ID`, `GMAIL_CLIENT_SECRET`, `GMAIL_REFRESH_TOKEN`은 `backend/app/core/config.py`, `.env_example`, `docs/guides/ENVIRONMENT_VARIABLE_SETUP.md`에 변수명으로 존재하지만, Gmail API 발송 구현은 아직 없다.
