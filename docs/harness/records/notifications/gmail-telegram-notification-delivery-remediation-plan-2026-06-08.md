...
- `docs/guides/ENVIRONMENT_VARIABLE_SETUP.md` 및 `.env.example`
...
- `docs/harness/features/deployment-runtime.md`
- `docs/harness/feature-index.md`
- 새 구현 기록: `docs/harness/records/notifications/gmail-telegram-notification-delivery-remediation-implementation-2026-06-08.md`
