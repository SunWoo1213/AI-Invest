...
`docs/harness/records/notifications/favorite-asset-notification-plan-2026-06-02.md`의 MVP 기반을 구현했다. 계정 기반 즐겨찾기, 알림 설정, 채널 연결, 알림 이력, 가격/뉴스/저장 리포트 변경 감지, 안전한 발송 adapter와 프론트 설정 화면을 추가했다.
