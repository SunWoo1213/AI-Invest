...
Turn the finance-quality feedback in `docs/harness/records/ai-report/report-writing-method-feedback-2026-06-01.md` into an implementation plan for future work.
...
`docs/architecture/PROJECT_STRUCTURE_ANALYSIS.md` was referenced by the repository instructions but is not present in the current checkout.
