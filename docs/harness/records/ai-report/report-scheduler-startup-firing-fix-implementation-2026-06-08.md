...
분석 출처: `docs/harness/records/ai-report/report-generation-scheduler-not-firing-log-audit-2026-06-08.md` (1차 로그, 1순위 원인) / 에러 케이스북 사례 15.
...
- 분석/케이스북: `docs/harness/records/ai-report/report-generation-scheduler-not-firing-log-audit-2026-06-08.md`(1순위 구현 상태 갱신), 에러 케이스북 사례 15(해결 표시).
- 환경변수 문서: `docs/guides/ENVIRONMENT_VARIABLE_SETUP.md`, `docs/guides/ENVIRONMENT_VARIABLE_RECOMMENDATIONS.md`의 `REPORT_SCHEDULER_STARTUP_DELAY_SECONDS` 설명을 새 기본값(60)·동작(interval next_run_time)으로 갱신.
