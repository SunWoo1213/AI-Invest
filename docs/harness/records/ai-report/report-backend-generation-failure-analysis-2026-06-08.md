...
해결 계획은 `docs/harness/records/ai-report/report-backend-generation-remediation-plan-2026-06-08.md`에 분리했다. 실제 해결은 provider/env 점검과 일부 관측성 개선을 포함할 수 있으며, scheduler cadence 또는 AI 호출 비용에 영향을 주는 변경은 사용자 확인 후 진행해야 한다.
