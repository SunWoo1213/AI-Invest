...
Implement the first safety and quality-gate steps from `docs/harness/records/ai-report/report-quality-improvement-plan.md` without requiring a database schema migration.
