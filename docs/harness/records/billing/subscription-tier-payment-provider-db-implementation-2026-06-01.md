...
Implement the database-backed subscription state and provider-neutral payment boundary planned in `docs/harness/records/billing/subscription-tier-payment-provider-db-implementation-plan-2026-06-01.md` without selecting or calling a live production payment provider.
