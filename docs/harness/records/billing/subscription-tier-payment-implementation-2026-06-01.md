...
Start the tiered subscription implementation from `docs/harness/records/billing/subscription-tier-payment-plan-2026-06-01.md` without making the risky payment-provider or database schema changes that still need product confirmation.
