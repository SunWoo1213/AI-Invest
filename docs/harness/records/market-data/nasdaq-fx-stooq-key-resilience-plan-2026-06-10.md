...
- stooq 무료 apikey의 한계(루트 [STOOQ_APIKEY_GUIDE.md](../../../guides/STOOQ_APIKEY_GUIDE.md) §5에 기록):
...
| 문서(가이드) | `docs/guides/STOOQ_APIKEY_GUIDE.md` | "한도 소진 증상 = 나스닥/달러등락만 사라짐", provider-health로 상태 확인하는 법, 재발급 절차 재안내 보강(시크릿 미기재) |
...
2. 빈 결과면 [STOOQ_APIKEY_GUIDE.md](../../../guides/STOOQ_APIKEY_GUIDE.md) §2 절차로 **캡차 재발급 → `.env`의 `STOOQ_API_KEY` 교체 → 백엔드 재기동**.
...
- `docs/guides/STOOQ_APIKEY_GUIDE.md`
