...
- `.env.example`도 같은 5개 기본값을 안내한다.
  - `.env.example:243`
- 반면 `docs/harness/records/market-data/dashboard-indices-live-provider-2026-06-08.md`는 이미 홈 4개를 allowlist에 추가했다고 기록한다. 현재 코드와 문서가 충돌하므로, 후속 구현 시 현재 코드를 기준으로 다시 정합화해야 한다.
...
- 기존 `docs/harness/records/market-data/dashboard-indices-live-provider-2026-06-08.md`
