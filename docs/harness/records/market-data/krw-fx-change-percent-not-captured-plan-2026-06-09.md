...
- 구현 단계에서 `docs/harness/records/market-data/krw-fx-change-percent-not-captured-implementation-2026-06-09.md` 변경 기록 작성.
- (B)안 채택 시 [ENVIRONMENT_VARIABLE_SETUP.md](../../../guides/ENVIRONMENT_VARIABLE_SETUP.md)에 신규 플래그 추가.
