...
Related:
- `docs/harness/records/market-data/market-data-warmup-provider-throttle-timeout-implementation-2026-06-04.md` (직전 A+C: 타임아웃 상향 + 워밍업 비차단화)
- `docs/harness/records/market-data/market-data-warmup-provider-throttle-timeout-plan-2026-06-03.md` (후보 B/E의 출처)
