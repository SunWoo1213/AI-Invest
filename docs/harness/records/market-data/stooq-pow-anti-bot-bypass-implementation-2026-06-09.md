...
- 사용자용 발급 절차는 루트 `docs/guides/STOOQ_APIKEY_GUIDE.md` 참고. apikey가 PoW를 우회하지 못한다는 점(본 구현으로 해소)도 거기에 기록돼 있다.

## 참고

- 사용자 가이드: `docs/guides/STOOQ_APIKEY_GUIDE.md` (루트)
- 관련: `docs/harness/records/market-data/nasdaq-index-stooq-primary-implementation-2026-06-09.md`, `docs/harness/records/market-data/krw-fx-change-percent-not-captured-implementation-2026-06-09.md`, `docs/harness/records/market-data/stooq-timeout-fallback-2026-06-07.md`
